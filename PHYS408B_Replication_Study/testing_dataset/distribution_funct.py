...
# Calculates the stats of the dataset
...
# Plots the two datasets to analyze its distribution
def distribution_check(dataset1, dataset2, save_name="Temp_name", save=False):

    # Sort the values by magnetism
    ...
    ax1.set_title("Checking for distribution of data")
    ...
    if save == True:
        ...
        fig.savefig(f"../images/distribution/{save_name}.svg", format='svg', dpi=1200)
